<%@ page language="java" import="model.Person" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" %>
...
<body>
    <form id="form1" class="liger-form" data-validate="{}">
        <div class="fields">
            <input data-type="text" data-label="StudentName" data-name="StudentName" value="<%=p.getName()%>" validate="{required:true,minlength:5}" />
            <input data-type="text" data-label="ID Number" data-name="ID" value="<%=p.getSsn()  %>" validate="{required:true}" />
        ...
        <div>
            <div style="margin: 4px; float: left;">
               ...
               <li value="${se.getSectionNo()}">${se.getRepresentedCourse().getCourseName()}</li>
               </c:forEach>
               </ul>
...
<script type="text/javascript">
    ...
    function moveToRight() {
        ...
        //调用后台执行选课操作
        $.post(
                "../enrollCourseServlet?selecteds="+selecteds+"&ssn="+ssn,
                function (result) {
